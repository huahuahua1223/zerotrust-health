...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Card className="card-hover h-full overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm">
      {/* Header accent */}
      ...
      <CardFooter className="gap-2 border-t bg-muted/20 p-4">
        ...
        <Button asChild className="flex-1 bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-150">
